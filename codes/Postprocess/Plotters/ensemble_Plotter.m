...
load('objects/Workspaces/ILM_Ensemble_MT.mat');
...
figure(1)
ploterrhist(e)
title([VariableLabels(end) ' Error Histogram (Ensemble Method)'],...
    'Fontsize', 16);
ax = gca;
...
title([VariableLabels(end) ' Predictor Importance Estimates (Ensemble Method)'],...
    'Fontsize', 16);
