...
% MINOLTA AND TOBII PRO GLASSES 2 - AVERAGE PUPIL DIAMETER MODELED BY LIGHT
% INTENSITY, SPECTRUM AND HEAD ROTATION
...
Data = [Clean_APD_MT_Table(:,invarVec) Clean_APD_MT_Table(:,outvarVec)];
...
% MODEL FOR RIGHT PUPIL DIAMETER
