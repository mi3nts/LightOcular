...
% MINOLTA AND TOBII PRO GLASSES 2 - PUPIL DIAMETER DIFFERENCE MODEL 
% MODELED BY LIGHT INTENSITY, SPECTRUM AND HEAD ROTATION

% CODE AUTHORED BY: SHAWHIN TALEBI
% THE UNIVERSITY OF TEXAS AT DALLAS
% MULTI-INTEGRATED REMOTE SENSING AND SIMULATION (MINTS)

% load all data in table form. Clean_PDD_MT_Table does not include any rows
% where thePupil diameters were measured as zero nor the columns
% corresponding to the error variables, it also includes the variable
% PupilDiameterDifference, and does not include the datetime variable

load('Clean_PDD_MT_Table.mat');
...
Data = [Clean_PDD_MT_Table(:,invarVec) Clean_PDD_MT_Table(:,outvarVec)];
...
% save workspace
save('Workspaces/PDD_ensemble_MT.mat');