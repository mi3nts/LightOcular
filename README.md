...
This repository contains codes and data for the paper: _**Modeling Autonomic Pupillary Responses from External Stimuli Using Machine Learning**_ (https://doi.org/10.26717/BJSTR.2019.20.003446). The raw data consists of spectral and pupillometric data collected during three outdoor/indoor walks using the Konica Minolta CL-500A Illuminance Spectrophotometer and Tobii Pro Glasses 2. 
...
An overview of the data preparation process is as follows:
   ...
   5. The Merged table is cleaned using the codes located in the folder **codes/Preprocess/DataCleaner**
